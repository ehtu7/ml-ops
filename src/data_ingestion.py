...
def main():
    try:
        #data_path = os.path.join(os.path.dirname(os.getcwd()), '../data/raw/spam.csv')
        ...
        save_data(train_data, test_data, data_path=r'C:\Users\ehtmazha\OneDrive - Publicis Groupe\Desktop\AIPormt\ml-ops\data')
    except Exception as e:
